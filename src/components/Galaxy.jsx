...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    const maxPixelRatio = isLowPowerDevice ? 0.8 : 1.1;
    ...
    if (mouseInteraction && !isLowPowerDevice) {
  ...
  return <div ref={containerRef} className={`galaxy-container ${className}`} style={style} {...rest} />;
}
